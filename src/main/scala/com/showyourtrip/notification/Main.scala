...
import com.showyourtrip.notification.services.{NotificationConsumerActor, StoreActor}
...
object Main extends App {
  ...
  val notificationActor = actorSystem.actorOf(Props(classOf[NotificationConsumerActor], storeActor, eventBusPath), "notification")
